...
# which will contain the players of the guild). The class also has 3 additional methods:
# -	assign_player(player: Player)
# o	Adds the player to the guild and returns "Welcome player {player_name} to the guild {guild_name}". Remember to
# change the player's guild in the player class.
...
# o	Removes the player from the guild and returns "Player {player_name} has been removed from the guild.". Remember to
# change the player's guild in the player class to "Unaffiliated".
