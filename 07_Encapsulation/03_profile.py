...
# and at least one digit. If it does not, raise a ValueError with the message "The password must be 8 or more
...
class Profile:
    ...
    def password(self, value):
        ...
        if is_upper_case_presented and is_digit_presented and is_length_valid:
